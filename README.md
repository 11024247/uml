...
## 6.2、類的關係
## 6.2.1關聯關係: ![image](https://github.com/XUYR00/MID/blob/main/image/arrow1.png)
>描述了類的結構之間的關係，具有方向、名字、角色和多重性等信息。
![image](https://github.com/XUYR00/MID/blob/main/image/pic1.png)

>一般的關聯關係語意較弱，也有兩種語意較強，分別是聚合和組合
## 聚合關係:![image](https://github.com/XUYR00/MID/blob/main/image/arrow2.png)
>特殊關聯關係，指明一個聚合(整體)和組成部分之間的關係
![image](https://github.com/XUYR00/MID/blob/main/image/pic2.png)
## 組合關係:![image](https://github.com/XUYR00/MID/blob/main/image/arrow3.png)
>語意更強的聚合，部分和整體具有相同的生命週期
![image](https://github.com/XUYR00/MID/blob/main/image/pic3.png)
## 6.2.2、泛化關係:![image](https://github.com/XUYR00/MID/blob/main/image/arrow4.png)
>在面向對象中一般稱為繼承關係，存在於父類與子類、父接口與子接口
![image](https://github.com/XUYR00/MID/blob/main/image/pic4.png)
![image](https://github.com/XUYR00/MID/blob/main/image/pic5.png)
## 6.2.3、實現關係:![image](https://github.com/XUYR00/MID/blob/main/image/arrow5.png)
>對應於類和接口之間的關係
![image](https://github.com/XUYR00/MID/blob/main/image/pic6.png)
## 6.2.4、依賴關係:![image](https://github.com/XUYR00/MID/blob/main/image/arrow6.png)
...
## ⑦、類圖思維導圖
![image](https://github.com/XUYR00/MID/blob/main/image/pic7.png)
## ⑧、以機房收費系統為實例繪製類圖
...
## 9.2類圖與對象圖的區別?
![image](https://github.com/XUYR00/MID/blob/main/image/9.2.png)
## 對象圖:
![image](https://github.com/XUYR00/MID/blob/main/image/9.2.drawio%20(2)%20(1).png)
### 網站:https://blog.csdn.net/Elsa15/article/details/84700651
